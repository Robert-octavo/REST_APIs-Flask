...
class LinkTagsToItem(MethodView):
    ...
    def post(self, item_id, tag_id):
        ...
        try:
            ...
            abort(500, message="An erroe occurred while inserting the tag.")
    ...
    def delete(self, item_id, tag_id):
        ...
        try:
            ...
            abort(500, message="An erroe occurred while deleting the tag.")
...
class Tag(MethodView):
    ...
    def delete(self, tag_id):
        ...
        abort(400, message="Could not delete tag. Make sure tag is not associated with items, the try again.")
